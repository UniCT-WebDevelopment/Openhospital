...
@ToString
public class AddUserOutput extends GenericOutput {
  @JsonProperty("userId")
  private Integer userId;

  public AddUserOutput result(Result result) {
    this.result = result;
    return this;
  }

  public AddUserOutput userId(Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddUserOutput addUserOutput = (AddUserOutput) o;
